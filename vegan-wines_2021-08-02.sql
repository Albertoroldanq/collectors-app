...
# Generation Time: 2021-08-02 10:48:43 +0000
# ************************************************************
...
VALUES
	(1,'Viñalba Malbec','Argentina','Red','Malbec'),
	(2,'Mas Querido','Spain','White','Macabeo'),
	(3,'Grüner Veltliner','Austria','White','Gruner Veltliner'),
	(4,'Herdade de Gambia','Portugal','Red','Touriga Nacional'),
	(5,'La Belle Angèle','France','White','Sauvignon Blanc');
